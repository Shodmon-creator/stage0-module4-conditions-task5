# stage0-module4-conditions-task5
Tasks:
1. Basic switch.
...
Rewrite "7. Days in month printer." from task 3 (https://autocode-next.lab.epam.com/courses/189/structure/tasks/3503) with switch :
